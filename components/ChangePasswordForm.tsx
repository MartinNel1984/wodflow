...
export function ChangePasswordForm({ className }: { className: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className={className}>
      <h2 className="font-semibold text-sm uppercase tracking-wider text-ink/50">Change password</h2>
      ...
      {success && <p className="text-green-700 text-sm bg-green-50 rounded-lg px-3 py-2">Password updated.</p>}

      <div>
        <label className="block text-xs font-semibold uppercase tracking-wider mb-2">Current password</label>
        <input
          type="password"
          required
      ...
      <div>
        <label className="block text-xs font-semibold uppercase tracking-wider mb-2">Confirm new password</label>
        <input
          type="password"
          required
