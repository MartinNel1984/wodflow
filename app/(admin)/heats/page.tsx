...
// Quick jump-off point to a division's public heat sheet — same pattern
// as /leaderboards, there was no way to reach it from the admin nav
// before, only by knowing/guessing the direct /heats/[divisionId] URL.
export default async function HeatsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <h1 className="text-2xl font-semibold">Heats</h1>
